...
This template's "Note for {name}" callouts are placeholders for whoever is writing the test — replace {name} with your own name, and delete each note once its spot is filled in.
