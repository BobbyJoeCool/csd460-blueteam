...
-- File: MoffatBayMarinaDB_V1-7-0.sql
-- Purpose: Builds the complete database FROM SCRATCH at version 1.7.0 -
--          the state it is in today. This single file replaces the old
--          four-step path of running MoffatBayMarinaDB_V1-4-0.sql and then
--          the V1-5-0, V1-6-0, and V1-7-0 update scripts in order. Those
--          four files still exist, under Legacy/Week5/, as the record of
--          how the schema got here; this is the file to actually run.
--          (V1-4-0.sql was itself a consolidation of an earlier five-step
--          path - see Legacy/Week4/ for that older history.)
--
...
-- Date: 2026-09-14
-- =============================================================================
-- Run this script as a MySQL admin/root user (e.g. `mysql -u root -p < MoffatBayMarinaDB_V1-7-0.sql`).
...
-- currentVersion.sql reads the last row, so this instance reports 1.7.0.
